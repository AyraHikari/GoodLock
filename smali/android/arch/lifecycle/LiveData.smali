...
.method static synthetic a(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/n;)V
    ...
    .line 1125
    invoke-virtual {v0}, Landroid/arch/a/b/b;->a()Landroid/arch/a/b/f;
    ...
    invoke-direct {p0, v0}, Landroid/arch/lifecycle/LiveData;->a(Landroid/arch/lifecycle/n;)V
...
.method private a(Landroid/arch/lifecycle/n;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/arch/lifecycle/LiveData",
            "<TT;>.android/arch/lifecycle/n;)V"
        }
    .end annotation

    .prologue
    .line 92
    iget-boolean v0, p1, Landroid/arch/lifecycle/n;->d:Z
    ...
    .line 100
    :cond_1
    invoke-virtual {p1}, Landroid/arch/lifecycle/n;->a()Z
    ...
    .line 104
    :cond_2
    iget v0, p1, Landroid/arch/lifecycle/n;->e:I
    ...
    iput v0, p1, Landroid/arch/lifecycle/n;->e:I
